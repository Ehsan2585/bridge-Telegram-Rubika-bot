...
از فایل‌های بزرگ (تا چند گیگابایت) پشتیبانی می‌کند، می‌تواند ویدیوهای یوتیوب را دانلود کند و فایل‌های حجیم را به‌صورت رمزگذاری‌شده تکه‌تکه (7z) ارسال می‌کند.و بعد از ارسال بلافاصله از روی سرور پاک می‌کنه تا فضای سرور اشغال نشه.
