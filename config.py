# ============================================================
#  فایل نمونه‌ی تنظیمات Bridge Bot
#  این فایل را به config.py کپی کنید و مقادیر خود را جایگزین کنید:
#      cp config.example.py config.py
#  (اسکریپت install.sh این کار را خودکار انجام می‌دهد.)
#  هشدار: فایل config.py واقعی را هرگز در گیت commit نکنید.
# ============================================================
